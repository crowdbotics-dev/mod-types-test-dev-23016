...
## Project Structure
    ...
    ├── mod_types_test_dev_23016  # Django project configurations
...
1. Clone this repo and `cd mod_types_test_dev_23016`
...
2. Clone this repo and `cd mod_types_test_dev_23016`
